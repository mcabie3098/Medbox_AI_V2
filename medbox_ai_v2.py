...
#Update
    def pushButton_Update(self):
        ...
        if is_internet():
            r = requests.get('https://github.com/mcabie3098/Medbox_AI')
            page = r.status_code
            if page==200:
                # NO UPDATES YET
                window=Tk()
                lbl=Label(window, text='No Updates Available', fg='black', font=("Helvetica", 12))
                lbl.place(x=65, y=35)
                window.title('Medbox AI')
                window.geometry("400x100+10+10")
                ...
                if messagebox.askokcancel('Medbox AI', 'Update is now available! \n\nDo you want to update now?', icon='info') == True:
                    # DOWNLOADING
                    window=Tk()
                    ...
                    git.Git("").clone("https://github.com/mcabie3098/Medbox_AI")
                    window1=Tk()
                    lbl=Label(window1, text='You are now up to date', fg='black', font=("Helvetica", 12))
                    lbl.place(x=65, y=35)
                    window1.title('Medbox AI')
                    window1.geometry("400x100+10+10")
                    window1.after(4000, lambda: window1.destroy())
                    window1.mainloop()
                    # NEW FEATURES
                    window=Tk()
            ...
            #NO INTERNET
            window=Tk()
            lbl=Label(window, text='No Internet Connection', fg='black', font=("Helvetica", 12))
            lbl.place(x=65, y=35)
            window.title('Medbox AI')
            window.geometry("400x100+10+10")
            window.after(2500, lambda: window.destroy())
